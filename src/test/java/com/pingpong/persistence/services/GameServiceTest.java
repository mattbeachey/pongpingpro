...
public class GameServiceTest {
    ...
    public void testSave() {
        ...
        System.out.println("Player ID: " + playerService.findByUsername("asdf").getId());

        game.setWinner(playerService.findByUsername("asdf"));
        game.setLoser(playerService.findByUsername("jkl;"));
